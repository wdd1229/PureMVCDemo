...
namespace PureMVC.Core
{
    ...
    public class View : IView
    {
        ...
        public virtual void NotifyObservers(INotification notification) //startup   mainUi               //SubmitMenu  order
        {
            ...
            if (list != null)
            {
                ...
                {
                    list[i].NotifyObserver(notification);   //startup     new Observer("executeCommand", this)    //SubmitMenu  order
                    // list[i]  == controll 也就是 new Observer("executeCommand", this) 中的 this
                }
            }
        }
        ...
        public virtual void RegisterObserver(string notificationName, IObserver observer)//STARTUP   new Observer("executeCommand", this)
        {
            lock (this.m_syncRoot)
            {
